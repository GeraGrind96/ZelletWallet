...
from config import STARTING_BALANCE, MAIN_WALLET_STARTING_BALANCE
...
class Wallet:
    ...
    """
    def __init__(self, blockchain=None, is_main=True):
        self.blockchain = blockchain
        self.address = str(uuid.uuid4())[0:8]
        self.main_wallet = is_main
    ...
    @property
    def balance(self):
        return Wallet.calculate_balance(self.blockchain, self.address, self.main_wallet)
    ...
    @staticmethod
    def calculate_balance(blockchain, address, is_main):
        """
        ...
        """
        if is_main == True:
            balance = MAIN_WALLET_STARTING_BALANCE
        else:
